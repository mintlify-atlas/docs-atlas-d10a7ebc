...
description: "Full walkthrough of a Memory-Assisted Shaping session: activating the protocol, shaping your idea, checking state, and producing a clean final artifact."
---
...
<Steps>
  ...
  <Step title="Present your idea (READING_ALIGNMENT)">
  ...
  <Step title="Shape the idea (SHAPING)">
  ...
  <Step title="Check state before synthesis">
  ...
  <Step title="Approve synthesis explicitly">
  ...
  <Step title="Receive the final artifact (SYNTHESIS)">
