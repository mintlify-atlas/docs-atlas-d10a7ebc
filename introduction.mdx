...
description: "Memory-Assisted Shaping is a ChatGPT Projects protocol that prevents session drift by tracking decisions, gates, and discarded paths with append-only memory signals."
---
