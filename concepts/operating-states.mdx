...
description: "Memory-Assisted Shaping uses three explicit operating states with strict entry and exit conditions to prevent premature synthesis and keep shaping separate from final artifact creation."
---
