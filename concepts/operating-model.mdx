...
description: "Memory-Assisted Shaping uses three ordered phases and an append-only Python layer. GPT emits typed signals but never reads or manages live memory files."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Gates" icon="filter" href="/concepts/gates">
