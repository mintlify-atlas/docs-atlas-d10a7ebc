...
description: "Memory signals are minimal typed records GPT appends to preserve continuity. Python owns persistence; the model never reads or rewrites the live log."
---
